    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="mt-2 text-sm text-neutral-600">
                {{ __('Atau') }}
                <a href="{{ route('register') }}" class="font-medium text-cream-600 hover:text-cream-700" wire:navigate>
                    {{ __('buat akun baru') }}
                </a>
            </p>
        </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input
                            ...
                            wire:model="remember"
                            type="checkbox"
                            class="w-4 h-4 text-cream-600 border-neutral-300 rounded focus:ring-cream-500"
                        />
            ...
            <div class="mt-6">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-2 bg-white text-neutral-500">{{ __('Atau masuk dengan') }}</span>
                    </div>
                </div>
